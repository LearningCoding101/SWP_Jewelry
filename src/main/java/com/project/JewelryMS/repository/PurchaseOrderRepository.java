...
//    @Query("SELECT SUM(po.revenueAmount) FROM PurchaseOrder po WHERE po.staffAccount.staffID = :staffId")
...
//
//    @Query("SELECT SUM(po.revenueAmount) FROM PurchaseOrder po WHERE po.staffAccount.staffID = :staffId AND po.purchaseDate BETWEEN :startDate AND :endDate")
